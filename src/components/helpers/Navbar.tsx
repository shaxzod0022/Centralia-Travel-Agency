...
const Navbar = () => {
  ...
  return (
    <div
      className={`${styles.flexBetween} z-50 bg-white fixed top-0 mx-auto max-w-[1800px] w-full navbar_shadow sm:px-12 md:px-20 lg:px-28 xl:px-40 2xl:px-52 lg:py-6 p-4`}
    >
      <div>
        <Link href={"/"}>
      ...
      <div className="lg:hidden block">
        <button onClick={() => setClose((i) => !i)} className="cursor-pointer">
